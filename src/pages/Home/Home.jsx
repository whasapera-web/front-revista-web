                    ...
                    <article className="relative w-full h-max flex flex-row p-4 justify-center items-start flex-wrap gap-12 xl:mt-8">
                        <div className="w-full flex flex-col justify-start items-start gap-4">
                            <div className="flex gap-1 items-center justify-center">
                                ...
                                <a href="https://www.facebook.com/profile.php?id=100063715656346" target="_blank" rel="noopener noreferrer" className="stroke-black text-xl md:text-2xl text-black xl:text-xl">FARMACIAS DE TURNO</a>
                            </div>
                            <div className="flex gap-1 items-center justify-center">
                                <div className="h-4 w-4 md:h-10 md:w-10 xl:w-6 xl:h-6 border-2 rounded-full bg-blue-400"> </div>
                                <a href="https://www.e-evhsa.com.ar/Horarios" target="_blank" rel="noopener noreferrer" className="stroke-black text-xl text-black md:text-2xl xl:text-xl">HORARIOS COLECTIVOS</a>
                            </div>
                            <div className="flex gap-1 items-center justify-center">
                            ...
                            <div className="flex items-center justify-center gap-1">
                                <div className="h-4 w-4 md:h-10 md:w-10 xl:w-6 xl:h-6 border-2 rounded-full bg-red-600"> </div>
                                <a href="https://www.sannicolasciudad.gob.ar/" target="_blank" rel="noopener noreferrer" className="stroke-black text-xl text-black md:text-2xl xl:text-xl">SN Trámites Municipales</a>
                            </div>
                        </div>
                        <div className="w-full flex flex-col justify-center items-start gap-4">
                            ...
                            <div className="flex gap-1 items-center justify-center">
                                <div className="h-4 w-4 md:h-10 md:w-10 xl:w-6 xl:h-6 border-2 rounded-full bg-pink-500"> </div>
