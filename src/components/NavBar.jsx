...
export default function NavBar() {
 const redirectHome = () => {
    ...
    return (
        <>
            <header className="xl:flex xl:justify-evenly xl:items-center xl:w-full le:mr-2 le:w-content z-50">
                <div className="flex justify-around items-center xl:flex xl:flex-row xl:justify-around xl:items-center xl:w-3/6">
                    <img src="/logo/logo-navbar.png" alt="imagen no soportada" className="w-16 md:w-24 xl:w-20" onClick={redirectHome}/>
